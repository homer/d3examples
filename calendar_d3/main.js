...
var month = 11;
var year = 2014;
/*cal.monthDays(2014, 11).forEach(function(week) {
  console.log(week);
});*/
...
weeks.forEach(function(week) {
  body
    ...
    .text(function(d) {
      // Only return day if its greater than 0... if inside current month
      return d > 0 ? d : '';
    })
});
},{"./consts":2,"calendar":3,"d3":4}],2:[function(require,module,exports){
var appConstants = {
